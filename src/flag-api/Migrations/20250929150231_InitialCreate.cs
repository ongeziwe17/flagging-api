        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PercentageRollout = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FlagAssignments_Environments_EnvironmentId",
                        column: x => x.EnvironmentId,
                        principalTable: "Environments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FlagAssignments_FeatureFlags_FeatureFlagId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FlagAssignments_EnvironmentId",
                table: "FlagAssignments",
                column: "EnvironmentId");

            migrationBuilder.CreateIndex(
                name: "IX_FlagAssignments_FeatureFlagId_EnvironmentId",
                table: "FlagAssignments",
